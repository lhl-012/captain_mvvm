...
public class StickyScrollView extends NestedScrollView {
	...
	public StickyScrollView(Context context, AttributeSet attrs, int defStyle) {
		...
		mShadowDrawable = context.getResources().getDrawable(R.drawable.sticky_shadow_default);//sticky_shadow_white或者sticky_shadow_default
...
//				int bottom = top + (int)(density * defaultShadowHeight + 0.5f);
				int bottom = mCurrentStickyView.getHeight();
