...
public class LStatusBarHelper {
    ...
    private static void translucent(Window window) {
    ...
    private static boolean supportTranslucent() {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT
                ...
                && !(LDeviceHelper.isEssentialPhone() && Build.VERSION.SDK_INT < 26);
    }
    ...
    public static void translucent(Window window, @ColorInt int colorOn5x) {
        ...
        // 小米和魅族4.4 以上版本支持沉浸式
        if (LDeviceHelper.isMeizu() || LDeviceHelper.isMIUI()) {
...
//            }
    ...
    private static boolean isMIUICustomStatusBarLightModeImpl() {
        if (LDeviceHelper.isMIUIV9() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            return true;
        }
        return LDeviceHelper.isMIUIV5() || LDeviceHelper.isMIUIV6() ||
                LDeviceHelper.isMIUIV7() || LDeviceHelper.isMIUIV8();
    }
    ...
    public static boolean supportTransclentStatusBar6() {
        return !(LDeviceHelper.isZUKZ1() || LDeviceHelper.isZTKC2016());
    }
    ...
    private static void initStatusBarHeight(Context context) {
        ...
        if (LDeviceHelper.isTablet(context)
    ...
    private static class LDeviceHelper {
