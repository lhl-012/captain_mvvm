package com.base.captain.widget.popwindow
...
import com.base.captain.widget.popwindow.rvDivider.HorizontalDividerItemDecoration
import com.base.captain.widget.popwindow.rvDivider.VerticalDividerItemDecoration
...
class WPopup(popParams: WPopParams) : BasePopup(popParams) {
        ...
        if (showDirection != oldDirection) {
            ...
            if (triangle == null) {
                ...
                if (showDirection == WPopupDirection.TOP) {
                    triangle!!.setBackgroundResource(R.drawable.pop_triangle_down)
                    commonRootLayout.addView(triangle, 1, params)
                } else {
                    triangle!!.setBackgroundResource(R.drawable.pop_triangle_up)
    ...
    class Builder(activity: Activity) {
        ...
        val view = activity.layoutInflater.inflate(R.layout.pop_common, null)
        private val popParams = WPopParams(view, activity)
